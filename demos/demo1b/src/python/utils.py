...
if sys.platform == 'darwin':
    ...
    # Miscellaneous/Foundation_Functions/Reference/reference.html#//apple_ref/
    # c/func/NSSearchPathForDirectoriesInDomains
    # NSApplicationSupportDirectory = 14
    # NSUserDomainMask = 1
    # True for expanding the tilde into a fully qualified path
    applicationDataPath = os.path.join(
        NSSearchPathForDirectoriesInDomains(14, 1, True)[0], applicationName)
elif sys.platform == 'win32':
    applicationDataPath = os.path.join(os.environ['APPDATA'], applicationName)
else:
    applicationDataPath = os.path.expanduser(
        os.path.join("~", "." + applicationName))
